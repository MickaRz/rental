...
$sql = "SELECT * FROM peminjaman p INNER JOIN detail_peminjaman dp ON p.id_pinjam=dp.id_pinjam
        INNER JOIN game b ON b.id_game=dp.id_game where p.id_pinjam='$id_pinjam'";
	...
	<div class="row mt-4">
		<div class="col-md-7">
			...
			<table class="table table-bordered">
                ...
                href="form-kembali.php?id_pinjam=<?=$detail['id_pinjam']?>&id_game=<?=$detail['id_game']?>" role="button">Form Pengembalian</a>
					</td>
				</tr>
			</table>
		</div>
